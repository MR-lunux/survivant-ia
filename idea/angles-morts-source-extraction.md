...
2. **Peut-on anonymiser durablement les données avant traitement** (réidentification à effort disproportionné) ?
   - Oui : les données sortent du champ de la LPD — large flexibilité. Rare en pratique pour des données immobilières ou financières, souvent réidentifiables par recoupement.
